...
function loadProblemData(problemData) {
    ...
    populateProblemName(problemData.common, problemData.scientific, problemHero, mainContent);
    populateSymptoms(problemData.leafTags, problemData.flowerTags, problemData.stemTags, problemData.rootTags, problemData.growthTags, problemData.wholeTags, mainContent);
    populateProblemInfo(problemData.treatment, problemData.information, mainContent);
}
